...
- [8-Bit Basic](https://www.youtube.com/@8-BitBasic) BASIC programming on real vintage computers. This channel is all about the Commodore 64 and the golden age of 8-bit computing. I type in real BASIC programs from scratch — games, demos, and experiments — and explain every line as I go. Yes, I will mess it up. That's part of the experience. Whether you're learning retro computing from scratch, reliving the 1980s home computer era, or just curious how those old machines actually worked, you'll fit right in. New videos every week. Welcome to 8-Bit Basic.
...
- [CoreDumped](https://www.youtube.com/@CoreDumpped) I'm a SC Engineer and I love teaching others about complex concepts I've learn over the years, but in a simple and easy to understand format.
...
- [rats159](https://www.youtube.com/@awesome.rats159) Opinionated and educational videos on programming.
- [Rust Nederland](https://www.youtube.com/@rustnederlandrustnl) Rust NL organizes meetups (talks and workshops) about Rust, the programming language that empowers everyone to build reliable and efficient software. We host meetups in different cities in The Netherlands, and on all kinds of topics and domains.
...
- [The Coding Train](https://www.youtube.com/@TheCodingTrain) All aboard! The Coding Train is on its way with creative coding video tutorials on subjects ranging from the basics of programming languages like JavaScript to algorithmic art, machine learning, simulation, generative poetry, and more. Choo choo!
...
- [VCF Southwest](https://www.youtube.com/@VCFSW) Home of the Vintage Computer Festival Southwest. Featuring content from our show and friends.
...
- [Alan Zucconi](https://www.youtube.com/@AlanZucconi) Game Development, Artificial Intelligence, Shader Coding & Retrocomputing.
...
- [Bofner](https://www.youtube.com/@Bofner) I'm Bofner, a passionate retro game enthusiast turned programmer, and founder of Steelfinger Studios! I make content on how 8-bit systems work under the hood, and the games and tools I make for them!
...
- [Khanage](https://www.youtube.com/@khanage1344) I mostly make videos about fighting games!
...
- [LeaveCurious](https://www.youtube.com/@LeaveCurious) This channel explores & tells stories of Rewilding. Creating content with aim of leaving you a little more curious than you arrived.
...
- [Max Roving](https://www.youtube.com/@MaxRoving) Travelling to places most people wouldn't go. Currently cycling around the world.
...
- [TarikBelasri](https://www.youtube.com/@TarikBelasri/) 👋 I'm Tarik Belasri — Licensed Tour Guide in Morocco & founder of Morocco Holiday Services, a licensed Travel Agency & DMC in Marrakech & Casablanca. +11 years of experience, approved by the Ministry of Tourism of Morocco. Authentic stories & insider tips from Morocco: Marrakech, Fes, Casablanca, Tangier, Chefchaouen, the Sahara (Merzouga & Erg Chebbi), Atlas Mountains & Essaouira.
...
- [Dr. Roy Casagranda](https://www.youtube.com/@DrRoyCasagranda) This is the official home of Dr. Roy Casagranda, where history, politics, and culture meet to reveal the stories that shape our world.
...
- [Leonidas Sparta](https://www.youtube.com/@LeonidasSparta-Fun-History) Re-creating the Hoplite and bringing history to life!
...
- [Stas Konstantinov](https://www.youtube.com/@StasFiestas) Soy el Ruso Holandes viviendo en la hermosa Colombia 🇨🇴
...
- [Roflwaffle](https://www.youtube.com/@Roflwaffle16) Racing game and motorsport retrospectives, video essays and deep dives. Original content only.
...
- [Cube Chemistry](https://www.youtube.com/@CubeChemistry) Look no further! On Cube Chemistry, we dive into the fascinating world of chemistry, exploring the elements of the periodic table in a unique way - inside acrylic cubes! Are you curious about the world of chemistry and science?
...
- [Ian Lauer Astro](https://www.youtube.com/@ianlauerastro) Bringing the stars back into your life. I'm Ian, an adventure astronomer and astrophotographer. It's my life's mission to reconnect as many people as possible to the night sky. Come join me on my adventures as we explore the world and the universe.
